...
public class InwarrentyCreateAPIDBDataProviderTestWith {

	@Test(description = "Verifying if the  Create api is able to Create InWarrenty Job ", groups = { "api",
			"regression",
			"smoke" ,"Faker"}, dataProvider = "CreateJobAPIDBDataProvider", dataProviderClass = com.Inwarrenty.dataprovider.DataProviderUtils.class)
