...
public class InwarrentyCreateAPIDataProviderTestWithJson {
	...
	@Test(description = "Verifying if the  Create api is able to Create InWarrenty Job ", groups = { "api",
			"regression",
			"smoke" ,"Faker"}, dataProvider = "createJobAPIJsonDataProvider", dataProviderClass = com.Inwarrenty.dataprovider.DataProviderUtils.class)
